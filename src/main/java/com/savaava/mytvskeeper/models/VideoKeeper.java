...
public class VideoKeeper {
    ...
    public class CsvHandler {
         ...
         */
        private int csvImportMoviesVersion11(Scanner scanner) throws Exception {
            ...
            while(scanner.hasNext()) {
                ...
                String durationHoursMins = scanner.next();
                ...
                int duration = 0;
                if(! durationHoursMins.isEmpty()){
                    String[] parts = durationHoursMins.split(" ");

                    for (String part : parts) {
                        if(part.endsWith("h")){
                            duration += Integer.parseInt(part.replace("h", "")) * 60;
                        }else if(part.endsWith("min")){
                            duration += Integer.parseInt(part.replace("min", ""));
                        }
                    }
                }
        ...
        public int csvImportMovies(File fileSource) throws Exception {
            try(Scanner scanner = new Scanner(new BufferedReader(new FileReader(fileSource)))){
                ...
                if(version.equals(CURRENT_VERSION))
                    ...
                    return csvImportMoviesVersion11(scanner);
                else{
        ...
        private int csvImportTVSerieVersion11(Scanner scanner) throws Exception {
        ...
        public int csvImportTVSerie(File fileSource) throws Exception {
            try(Scanner scanner = new Scanner(new BufferedReader(new FileReader(fileSource)))){
                ...
                if(version.equals(CURRENT_VERSION))
                    ...
                    return csvImportTVSerieVersion11(scanner);
                else{
                    System.err.println("Version not found");
                    return 0;
                }
        ...
        private int csvImportAnimeSerieVersion11(Scanner scanner) throws Exception {
        ...
        public int csvImportAnimeSerie(File fileSource) throws Exception {
            try(Scanner scanner = new Scanner(new BufferedReader(new FileReader(fileSource)))){
                ...
                if(version.equals(CURRENT_VERSION))
                    ...
                    return csvImportAnimeSerieVersion11(scanner);
                else{
                    System.err.println("Version not found");
                    return 0;
                }
